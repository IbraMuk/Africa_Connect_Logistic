...
export default function TransportPersonnelPage() {
  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        subtitle="Gérez les réservations de transport pour le personnel"
        action={{
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-6">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Rechercher une réservation par nom, référence ou trajet..."
            value={searchTerm}
